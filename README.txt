...
a persistence unit "pruebaECPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "pruebaEC/pom.xml":
...
artifact ("pruebaEC.war") is already built. You can build
